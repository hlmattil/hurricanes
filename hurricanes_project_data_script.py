...
# function that converts listed damages into floats and returns the data as a list:

def convert_damages_float(damages_list):
    damages_list_float = []
    for cost in damages:
...
damages_adjusted = convert_damages_float(damages)

print(damages_adjusted)
